...
-- 2. Connect to the database.
-- 3. Run each SQL file as shown below and in the same order.
-- 			db2 -vf Rollback_Extension_MetaData_DB2.sql
-- 			db2 -vf Rollback_Extension_CONSTRAINTS_DB2.sql
-- 			db2 -vf Rollback_Extension_TRIGGERS_DB2.sql
-- 			db2 -vf Rollback_Extension_SETUP_DB2.sql
--#SET TERMINATOR ;
